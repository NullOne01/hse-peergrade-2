            ...
            localDict = new Dictionary<string, string>()
        {
            ...
            {"HELP", "help - выводит это меню." + Environment.NewLine +
                     ...
                     "print \"PATH_FILE\" \"UTF-8/UTF-7/UTF-32/ASCII\" - " +
                        "выводит содержимое файла в одной из кодировок (UTF-8/UTF-7/UTF-32/ASCII). " + Environment.NewLine +
                     "copy \"PATH_FILE\" \"PATH_FILE\" - копирует первый файл на место второго файла. " + Environment.NewLine +
                     ...
                     "create \"PATH_FILE\" \"SOME_TEXT\" - создаёт файла с текстом внутри в кодировке UTF-8. " + Environment.NewLine +
                     "create \"PATH_FILE\" \"SOME_TEXT\" \"UTF-8/UTF-7/UTF-32/ASCII\" - " +
                        "создаёт файла с текстом внутри в выбранной кодировке (UTF-8/UTF-7/UTF-32/ASCII). " + Environment.NewLine +
